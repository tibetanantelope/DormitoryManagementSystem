<template>
  <el-card style="margin: 15px; min-height: calc(100vh - 80px)">
        ...
        <el-timeline>
          ...
          >
            <el-link
                ...
                @click="openNoticeDetail(activity.id)"
            >
              {{ activity.title }}
            </el-link>
          </el-timeline-item>
    ...
    <el-dialog v-model="showNoticeDialog" width="50%" :title="noticeDetail.title || '公告详情'">
      <div v-if="noticeDetail.content" style="white-space: pre-wrap; max-height:60vh; overflow:auto;">
